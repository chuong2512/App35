...
public class Key
{
    public const string PACK1 = "app35_pack1";
    public const string PACK2 = "app35_pack2";
    public const string PACK3 = "app35_pack3";
    public const string PACK4 = "app35_pack4";


    public const string PACK1_REGISTER = "register_app35_pack1";
    public const string PACK2_REGISTER = "register_app35_pack2";
    public const string PACK3_REGISTER = "register_app35_pack3";
    public const string PACK4_REGISTER = "register_app35_pack4";
    public const string PACK5_REGISTER = "register_app35_pack5";
}
